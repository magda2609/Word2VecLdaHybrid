...
from output.results import sort_and_save_topics, cleanup, save_word2vec_topics, choose_topic, save_and_calculate_topic_document_distribution
...
doc_topic = choose_topic(extended_topics, words_in_documents, len(files), settings.topics, logger)
logger.info("Saving document_topics_distributions:")
save_and_calculate_topic_document_distribution(settings.filename_types.getFilenames(), doc_topic, settings.all_output, settings.topics)
